...
const flueBaseUrl = process.env.FLUE_BASE_URL ?? "http://localhost:3583";
...
console.log(`Invoking Flue workflow penpot-simple at ${flueBaseUrl}`);
...
console.log(inspect(result.result, { depth: null, colors: true }));
