...
def get_exchange_rate(
    currency_from: str = "USD", currency_to: str = "EUR", currency_date: str = "latest"
):
    """
    ...
    try:
        ...
        print(f"get_exchange_rate.data ==> {data}")
        return data
...
class CurrencyAgent:
    ...
    def __init__(self) -> None:
        ...
        self.graph = create_react_agent(
            ...
            response_format=(self.FORMAT_INSTRUCTION, LlmResponseFormat),
        )
    ...
    async def stream(
        ...
        for item in self.graph.stream(
            ...
            # If message is a AIMessage contains Tool call, proceed to use the tool
            if (
            ...
            # If message is a ToolMessage contains process the tool result
        ...
        print(f"stream.agent_response ==> {agent_response}")
        yield agent_response

    def get_agent_response(self, config):
        print("\nat get_agent_response...")
        current_state = self.graph.get_state(config)
        structured_response = current_state.values.get("structured_response")

        if structured_response and isinstance(structured_response, LlmResponseFormat):
