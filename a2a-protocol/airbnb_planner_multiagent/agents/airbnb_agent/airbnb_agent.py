...
class AirbnbAgent:
    ...
    SYSTEM_INSTRUCTION = """
        You are a specialized assistant for Airbnb accommodations. Your primary function is to utilize the provided tools to search for Airbnb listings and answer related questions.
    ...
    # @todo could use structured output
    ...
    def __init__(self, mcp_tools: list[Any]) -> None:
        ...
        """
        logger.trace("Initializing AirbnbAgent with preloaded MCP tools...")
    ...
    async def ainvoke(self, query: str, session_id: str) -> dict[str, Any]:
        ...
        try:
            ...
            # Interesting how they decide to get it from state rather than just accessing the response from `ainvoke`
    ...
    # Only possible because the checkpointer is defined
